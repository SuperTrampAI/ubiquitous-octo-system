...
public class ImportExeclUtil {
	...
	public static void buildXLSX(String fileName, List<String[]> dataList) {
		try {
			...
			File file = new File("G:\\Downloads\\" + fileName);
			// 文件输出流
	...
	public static void main(String[] args) throws Exception {
		...
		File file = new File("C:\\Users\\huxiaolin\\Desktop\\点评.xlsx");
		System.out.println("file.getAbsolutePath()：" + file.getAbsolutePath());
		System.out.println("file.getname：" + file.getName());
		System.out.println("file.getPath()：" + file.getPath());
		// List<List<String>> list = poi.read("d:/aaa.xls");
		List<List<String>> list = poi.read("C:\\Users\\huxiaolin\\Desktop\\点评.xlsx");
		if (list != null) {
			for (int i = 0; i < list.size(); i++) {
				System.out.print("第" + (i) + "行");
				List<String> cellList = list.get(i);
				System.out.print("共" + (cellList.size()) + "列");
